...
pdf = samp.genPDF(N, 0, pctg, radius=radius, cyl=[0]) 
...
for imdcs in ['densCorr_Completed']:
    if imdcs == 'zeros':
    ...
    saveFig.save("brainData/exercise_irradiation/bruker_data/running_C/P14/rad_0.1/TV%.2f_XFM%.2f/%.2fper_result_uniform_im_dc_" % (TVWeight, XFMWeight, pctg) + imdcs)
